...
const { sdkClientOptions, writeError } = await import(
	pathToFileURL(join(root, "dist/esm/cli/runtime.js"))
);
	...
	const options = sdkClientOptions(
		{
			...
			apiKey: "test-key",
			xDedalusOrgId: "org-current",
		},
		command,
		[{ name: "api-key", optionKey: "apiKey", sdkKey: "apiKey" }],
	);
	let headers;

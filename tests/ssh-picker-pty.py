...
const api = {listMachines: (_cursor, signal) => mode === 'loading'
  ...
  : Promise.resolve({items: [
    {machine_id: '00000000-0000-4000-8000-000000000001', name: 'alpha', phase: 'running'},
    {machine_id: '00000000-0000-4000-8000-000000000002', name: 'beta', phase: 'sleeping'},
  ], next_cursor: null})};
...
def scenario(name, mode, keys, expected):
    ...
    try:
        while time.monotonic() < deadline:
            ...
            if not sent and ready in transcript and (mode == 'loading' or b'00000000-0000-4000-8000-000000000002' in transcript):
...
scenario('search and Enter select stable ID', 'ready', b'beta\r', '00000000-0000-4000-8000-000000000002')
scenario('arrow keys select machine', 'ready', b'\x1b[B\x1b[A\x1b[B\r', '00000000-0000-4000-8000-000000000002')
